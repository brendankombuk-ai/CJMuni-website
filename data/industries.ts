/**
 * Operating environments CJ MUNI works around. Categories are drawn only from
 * the supplied source material. No customer names or logos are implied.
 *
 * Images reuse the shared photo library where a real CJ MUNI photo fits the
...
export const INDUSTRIES: Industry[] = [
  { name: "Mining", image: "/images/library/drill-blast-services.jpg", imageAlt: "CJ MUNI crew on a mine bench with drill rig and explosives truck" },
  ...
  { name: "Infrastructure", image: "/images/library/engineering-civil-services.jpg", imageAlt: "Civil earthworks with excavator and haul truck" },
  { name: "Quarries", image: "/images/industries/quarries.jpg", imageAlt: "Aggregate quarry" },
  { name: "Exploration", image: "/images/library/field-vehicle.jpg", imageAlt: "CJ MUNI field vehicle on rough ground at a remote site" },
