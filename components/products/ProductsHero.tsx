 ...
 * on white rather than over a photograph.
 */
      ...
      <div className="frame py-8 sm:py-14">
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-label text-charcoal-light">
            ...
            <li className="flex items-center gap-2">
              <Link href="/capabilities/explosives-manufacture-supply" className="hover:text-ink">
            ...
            <li>
              <span className="text-charcoal">Orica Products</span>
            </li>
          </ol>
        </nav>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.15fr_1fr] lg:gap-16">
          <div>
            ...
            <h1 className="mt-4 font-heading text-3xl font-extrabold uppercase leading-[1.05] tracking-headline text-ink sm:text-4xl lg:text-5xl">
              Orica Products
            </h1>
            ...
            <p className="mt-5 max-w-2xl text-[13px] leading-relaxed text-charcoal-light sm:text-sm">
              {CATALOGUE_INTRO}
            </p>
          ...
          <figure className="m-0 w-full max-w-[560px] lg:ml-auto">
            <div className="relative aspect-[16/10] w-full overflow-hidden border border-black/10 bg-ink-800 sm:aspect-[25/18]">
              <Image
            ...
            <figcaption className="mt-3 text-xs text-charcoal-light">
